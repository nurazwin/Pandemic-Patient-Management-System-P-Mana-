...
try {
    $sql = "SELECT * FROM medicalstaff WHERE email = '$email' AND password = '$password'";
    ...
    if ($count > 0){
        ...
        echo "<script> window.location.replace('mslogin.html') </script>;";
    }
